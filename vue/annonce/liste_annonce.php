        ...
        <div class="form-search-wrap" data-aos="fade-up" data-aos-delay="200">
          <form method="post" action="index.php?controller=annonce&action=liste_avance">
            <div class="row align-items-center">
              <div class="col-lg-9 mb-4 mb-xl-0 col-xl-2">
              ...
              <div class="col-lg-12 col-xl-1 ml-auto ">
                <input type="submit" class="btn btn-primary btn-block rounded text-white" value="->">
              </div>
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-3">
        <div class="d-block d-md-flex listing vertical">
          <a href="index.php?controller=annonce&action=det&id_an=<?php echo $annonce->id_an;?>" class="img d-block" style="background-image: url(ac/images/hero_1.jpg);"> </a> <div class="lh-content">
