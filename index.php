  ...
  <header class="site-navbar container py-0 bg-white" role="banner">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-6 col-xl-2">
        <h1 class="mb-0 site-logo"><a href="index.html" class="text-black mb-0">Fripe<span class="text-primary">LOCAL</span> </a></h1>
      </div>
      <div class="col-12 col-md-10 d-none d-xl-block">
        <nav class="site-navigation position-relative text-right" role="navigation">
          ...
          <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
            ...
            <li><a style="<?php if (isset($_SESSION['id'])) echo "display:block;" ?>" href="index.php?controller=personne&action=logout">Déconnexion</a></li>
            ...
            <li><a href="#" class="cta"><span class="bg-primary text-white rounded">+ Créer une annonce</span></a></li>
          </ul>
        </nav>
      </div>
